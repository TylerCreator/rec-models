# Hybrid Contextual Recommender - Гибридная контекстная система рекомендаций
...
**Тестирование enriched features на оригинальном compositionsDAG**
