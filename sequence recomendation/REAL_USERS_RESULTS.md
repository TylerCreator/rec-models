...
│  ЭВОЛЮЦИЯ ПРОЕКТА                                            │
├──────────────────────────────────────────────────────────────┤
│  v3.0 Базовая (без персонализации)                          │
│  DAGNN: Accuracy 0.5152, nDCG 0.7893                        │
├──────────────────────────────────────────────────────────────┤
│  v3.1 С графовыми метриками                                 │
│  DAGNN: Accuracy 0.5152, nDCG 0.7893                        │
├──────────────────────────────────────────────────────────────┤
│  v4.0 С синтетическими пользователями (10 users)            │
│  Personalized DAGNN: Accuracy 0.5455, nDCG 0.8005           │
├──────────────────────────────────────────────────────────────┤
│  v4.1 С РЕАЛЬНЫМИ пользователями ⭐⭐⭐                       │
│  Personalized DAGNN: Accuracy 0.7576, nDCG 0.9105           │
│                                                              │
│  📈 УЛУЧШЕНИЕ: +47% accuracy, +15% nDCG                     │
│  🚀 ЛУЧШИЙ РЕЗУЛЬТАТ ЗА ВСЮ ИСТОРИЮ ПРОЕКТА!                │
└──────────────────────────────────────────────────────────────┘
```
...
### Personalized DAGNN с реальными пользователями:

| Метрика | Значение | Улучшение vs базовая |
|---------|----------|---------------------|
| **Accuracy** | **0.7576** | **+47.0%** 🚀 |
| **nDCG** | **0.9105** | **+15.3%** 🚀 |
| **Precision** | **0.6250** | **+83.8%** 🚀 |
| **Recall** | **0.7500** | **+50.0%** 🚀 |
| **F1-score** | **0.6667** | **+74.3%** 🚀 |
...
### 4. **Четкое разделение между пользователями**
