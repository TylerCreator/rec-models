...
**Задача:** Гибридные подходы, комбинирующие GNN и коллаборативную фильтрацию.

**Файлы:**
- `hybrid_gnn_cf_recommender_comparison.py` (377 строк)
- `compositionsDAG.json` - граф данных
- `calls.csv` - история вызовов

**Статус:** В разработке

**Директория:** [`hybrid/`](hybrid/)
